...
@Component({
  selector: 'app-helpandsupportnotification',
  templateUrl: './helpandsupportnotification.component.html',
  styleUrls: ['./helpandsupportnotification.component.css']
})
export class HelpandsupportnotificationComponent implements OnInit {
