(function (global, factory) {
	...
	(factory((global['ng-location-picker'] = {}),global.core,global.common));
...
var LocationPickerDirective = (function () {
    function LocationPickerDirective() {
        this.onPickedLocation = new core.EventEmitter();
    }
    /**
     * @return {?}
     */
    ...
    LocationPickerDirective.propDecorators = {
        "pickedLocationIcon": [{ type: core.Input },],
        "defaultCenter": [{ type: core.Input },],
        "onPickedLocation": [{ type: core.Output },],
        "searchBoxElement": [{ type: core.ViewChild, args: ['searchBox',] },],
...
exports.LocationPickerModule = LocationPickerModule;
exports.LocationPickerDirective = LocationPickerDirective;
